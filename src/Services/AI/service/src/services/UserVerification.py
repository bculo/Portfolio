...
class UserVerificationService:
    ...
    blob_config: BlobStorageServiceConfig
    ...
    async def verify_user_image(self, verification_req: VerificationRequest) -> VerificationResult:
        blob_info = self.blob_service.download_blob(self.blob_config.verification_cont(), verification_req.blob_identifier)
    ...
    def create_image_with_face_coordinates(self, verification_req: VerificationRequest, blob_info: BlobInfo, detection_result: DetectedFace):
        ...
        self.blob_service.upload_blob(modified_blob, 
                                      self.blob_config.verification_cont(), 
