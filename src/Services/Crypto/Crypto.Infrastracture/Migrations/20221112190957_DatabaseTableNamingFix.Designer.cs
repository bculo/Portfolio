...
namespace Crypto.Infrastracture.Migrations
{
    ...
    [Migration("20221112190957_DatabaseTableNamingFix")]
    partial class DatabaseTableNamingFix
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Crypto.Core.Entities.PortfolioAggregate.Portfolio", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Crypto.Core.Entities.PortfolioAggregate.PortfolioItem", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Crypto.Core.Entities.PortfolioAggregate.PortfolioItem", b =>
                {
                    b.HasOne("Crypto.Core.Entities.PortfolioAggregate.Portfolio", "Portfolio")
                        .WithMany("Items")
